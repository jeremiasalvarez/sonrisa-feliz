...
VALUES
  (
    1,
    'nico@gmail.com',
    '$2a$10$tVUnil.hkyOfOBkxikf.EumTDoJ.K8Vd9vHyPAxDw9PwkycU6N2qu',
    'paciente'
  ),
  (
    2,
    'fedebenitez1996@hotmail.com',
    '$2a$10$Uv9EBnF7NWf481pdWeSZFeYQOHJn8O3rjDGreVIZyEqVUQUHPYtAm',
    'paciente'
  ),
  (
    6,
    'admin@admin.com',
    '$2a$10$.fHJOQiZTiblcPpWR8Q2Veg5k8/NXx6901w4pkutWsPuAsGqsojmS',
    'admin'
  );
--
...
ALTER TABLE
  `ficha_paciente`
ADD
  CONSTRAINT `ficha_paciente_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`);
--
...
ALTER TABLE
  `obra_social_paciente`
ADD
  CONSTRAINT `obra_social_paciente_ibfk_1` FOREIGN KEY (`cod_obra_social`) REFERENCES `obra_social` (`cod_obra_social`),
ADD
  CONSTRAINT `obra_social_paciente_ibfk_2` FOREIGN KEY (`dni_paciente`) REFERENCES `ficha_paciente` (`dni`);
--
...
ALTER TABLE
  `turno_paciente`
ADD
  CONSTRAINT `turno_paciente_ibfk_1` FOREIGN KEY (`id_prestacion`) REFERENCES `prestaciones` (`id`),
ADD
  CONSTRAINT `turno_paciente_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`);
COMMIT;
